        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li>
                <a class="" href="{{route('user.profile', auth()->id())}}">
              ...
              <li> <a class="" href="{{route('new.patient')}}"><i class="fa fa-plus"></i> Add Patient</a></li>
              
              <li> <a class="" href="{{route('new.bank')}}"><i class="fa fa-plus"></i> Add Blood Bank</a></li>
              <li> <a class="" href="{{route('new.donor')}}"><i class="fa fa-plus"></i> Add Donor</a></li>
              @endif
              @if(auth()->user()->is_blood_bank)
                <li> <a class="" href="{{route('new.donor')}}"><i class="fa fa-plus"></i> Add Donor</a></li>
                <li> <a class="" href="{{route('donation.form')}}"><i class="fa fa-plus"></i> Register Donation</a></li>
              @endif
          ...
          <li>
            <a class="" href="{{route('donor.history', auth()->id())}}">
                          <i class="fa fa-user"></i>
         ...
         <li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li> <a class="" href="{{route('banks.list')}}"><i class="fa fa-file"></i>Blood Bank List </a></li>
              <li> <a class="" href="{{route('donors.list')}}"><i class="fa fa-file"></i>Donors Report</a></li>
              <li> <a class="" href="{{route('bb.report.form')}}"><i class="fa fa-file"></i>Blood Bank Details</a></li>
              @endif
