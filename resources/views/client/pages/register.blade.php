   ...
   <div class="col-lg-10 offset-lg-1">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6 ">
              ...
              <input type="number" class="form-control" name="is_patient" value="1" hidden>
          </div>
       
        <div class="text-center"><input class="btn btn-success" value="Register as Patient" type="submit"/></div>
{{-- 
        <div class="mb-3">
